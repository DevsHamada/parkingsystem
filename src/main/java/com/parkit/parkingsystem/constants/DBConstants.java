...
public class DBConstants {
    ...
    public static final String GET_VEHICLE = "select t.ID from ticket t where t.VEHICLE_REG_NUMBER=? limit 1";
    public static final String GET_VEHICLE_OUT = "select count(*) from ticket t where t.VEHICLE_REG_NUMBER= ? ";
